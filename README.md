...
1. **Line Chart**: Shows mean measurements across species
   - File: `line_chart.png`
   - ![Line Chart](line_chart.png)

2. **Bar Chart**: Displays average sepal length by species
   - File: `bar_chart.png`
   - ![Bar Chart](bar_chart.png)

3. **Histogram**: Shows distribution of sepal length
   - File: `histogram.png`
   - ![Histogram](histogram.png)

4. **Scatter Plot**: Visualizes sepal length vs petal length
